...
class AccountMove(models.Model):
    ...
    def init(self):
        ...
        self.env.cr.execute('DROP INDEX IF EXISTS account_move_journal_date_desc_idx')
        self.env.cr.execute("CREATE INDEX account_move_journal_date_desc_idx ON account_move (journal_id, date DESC)")
