...
var StatementModel = BasicModel.extend({
    avoidCreate: false,
    // TODO silog
    quickCreateFields: ['account_id', 'amount', 'analytic_account_id','cost_center_id','payment_budget_article_id', 'spending_authorization_id', 'label', 'tax_ids', 'force_tax_included', 'analytic_tag_ids', 'to_check'],
    ...
    quickCreateProposition: function (handle, reconcileModelId) {
        ...
        // TODO silog
        var fields = ['account_id', 'amount', 'amount_type', 'analytic_account_id','cost_center_id','payment_budget_article_id', 'spending_authorization_id', 'journal_id', 'label', 'force_tax_included', 'tax_ids', 'analytic_tag_ids', 'to_check', 'amount_from_label_regex', 'decimal_separator'];
...
var ManualModel = StatementModel.extend({
    // TODO silog
    quickCreateFields: ['account_id', 'journal_id', 'amount', 'analytic_account_id','cost_center_id','payment_budget_article_id', 'spending_authorization_id', 'label', 'tax_ids', 'force_tax_included', 'analytic_tag_ids', 'date', 'to_check'],
