...
class IrSequence(models.Model):
    ...
    def _get_prefix_suffix(self):
        ...
        def _interpolation_dict():
            ...
            if self._context.get('ir_sequence_date_range_from'):
                range_date_from = fields.Datetime.from_string(self._context.get('ir_sequence_date_range_from'))
            if self._context.get('ir_sequence_date_range_to'):
                range_date_to = fields.Datetime.from_string(self._context.get('ir_sequence_date_range_to'))
